...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static bool ColumnExists(string tableName, string columnName,string connString)
        {
            string sql = "select count(1) from syscolumns where [id]=object_id('" + tableName + "') and [name]='" + columnName + "'";
            object res = GetSingle(sql,connString);
            if (res == null)
            {
                return false;
            }
        ...
        public static int GetMaxID(string FieldName, string TableName,string connString)
        {
        ...
        /// <returns></returns>
        public static bool TabExists(string TableName,string connString)
        {
        ...
        public static bool Exists(string connString,string strSql, params SqlParameter[] cmdParms)
        {
            object obj = GetSingle(connString,strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        public static int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList,string connString)
        {
        ...
        /// </summary>
        /// <param name="SQLStringList">SQL语句的哈希表（key为sql语句，value是该语句的SqlParameter[]）</param>
        public static int ExecuteSqlTran(System.Collections.Generic.List<CommandInfo> cmdList,string connString)
        {
            using (SqlConnection conn = new SqlConnection(connString))
            {
                conn.Open();
        ...
        /// </summary>
        /// <param name="SQLStringList">SQL语句的哈希表（key为sql语句，value是该语句的SqlParameter[]）</param>
        public static void ExecuteSqlTranWithIndentity(System.Collections.Generic.List<CommandInfo> SQLStringList,string connString)
        {
            using (SqlConnection conn = new SqlConnection(connString))
            {
                conn.Open();
        ...
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(string connString, string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader ExecuteReader(string connString, string SQLString, params SqlParameter[] cmdParms)
        {
            SqlConnection connection = new SqlConnection(connString);
            SqlCommand cmd = new SqlCommand();
            try
