...
namespace RFIDSim
{
    ...
    public struct udpPackage
    {
       ...
       // public byte msb;
        ...
        public  byte[] UnPack()
        {
            ...
            {
                Console.WriteLine("rfid comm unpack:" + e.Message);
            }
        ...
        public bool Pack(byte[] byteStream)
        {
            ...
            {
                Console.WriteLine("rfid comm pack:" + e.Message);
            }
    ...
    class UDPServer
    {
        ...
        //构造函数
        public UDPServer(string hostIP, int port)
        {
            IP = System.Net.IPAddress.Parse(hostIP);
            S_Point = new System.Net.IPEndPoint(IP, port);
